...
_$jscoverage['app.js'].source = ["/*!"," * app.js"," * Copyright(c) 2012"," * Author: jifeng &lt;wade428@163.com&gt;"," */","","var app = require('./index');","var config = require('./config');","var server = app(config);","","server.run()"];
